...
public class ConvenienceStoreOrder {
        ...
        while (button) {
            ...
            switch (selectMenu) {
                ...
                case 2:
                    ...
                    String cancelGoods = scanner.next();
                    for (int i = 0; i < goods.length; i++) {
                        if (goods[i][0].equals(cancelGoods)) {
                            goods[i][0] = "등록가능";
                            goods[i][1] = "0";
                        }
                    }
                ...
                case 4:
                    ...
                    System.out.println("[System] 현재 등록된 물건 목 및 수량 ▼");
                    ...
                    String outGoods = scanner.next();
                    System.out.println("[System] 원하는 출고량을 입력하세요 : ");
                    int outGoodsQuantity = scanner.nextInt();

                    for (int i = 0; i < goods.length; i++) {
                        if (goods[i][0].equals(outGoods)) {
                            goods[i][1] = String.valueOf(Integer.parseInt(goods[i][1]) - outGoodsQuantity);
                        } else {
                            System.out.println("제품명이 일치하지 않습니다..! 다시 입력해주세요..!");
                        }
                        break;
